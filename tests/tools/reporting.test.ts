...
function createMockServer() {
  ...
  return {
    server: server as unknown as Parameters<typeof registerMetaTools>[0],
    tools,
  };
}
...
describe("reporting tools (canonical: defense_mgmt)", () => {
  let tools: Map<
    string,
    { schema: Record<string, unknown>; handler: ToolHandler }
  >;
  ...
  it("should register the defense_mgmt tool", () => {
